...
## Halo Effect
[Social - Belief - Politcs]
If you see a person as having a positive trait, that positive impression will spill over into their other traits. (This also works for negative traits) (l'abito fa il monaco)
- Taylor could never be mean, she's so cute!

## Moral Luck
[Memory - Social - Belief - Politcs]
Better moral standing happens due to a positive autcome. Worse moral standing happens due to a negative outcome.
...
## Curse of Knowledge
[Memory - Social - Belief - Politcs]
Once we know something, we assume everyone else know it, too.
...
[Memory - Learning - Belief - Money - Politci]
...
(è un po' il - Gli sta bene, perché se l'è meritato!)
- Luca è un bullo a scuola ed un giorno, fuoi da scula, mentre camminava tranquillamente, è stato preso a pugni da un ubriaco. Le persone dicono che gli sta bene e che se l'è meritato. 
...
- The only reason this person is doung something nice is to get something out of me
...
[Memory - Social - Learning - Belief - Money - Politcs]
...
## Anchoring
[Memory - Learning - Belief - Money]
We rely heavily on the first piece of information introduced when making decision.
- That's 50% off? It must be a great deal

## Automation Bias
[Memory - Learning - Belief]
...
## Reactance
[Social - Money - Politcs]
We do the opposite of what we're told, especially when we perceive threats to personal freedoms.
- One of Alice's students refuses to do his homework, even thoush both she and his parents tell him to.

## Confirmation Bias
[Memory - Learning - Belief - Politcs]
We tend to find and remember information that confirms our perceptions.
- You can confirm a cospiracy theory based on scant evidence while ignoring contrary evidence.

## Backfire Effect
[Memory - Learning - Belief - Politcs]
Disproving evidence sometimes has the unwarranted effect of confirming our beliefs.
- The evidence that disproves your conspirancy theory was probably faked by the government.

## Third-Person Effect
[Memory - Social - Learning - Belief - Politci]
...
## Belief Bias
[Memory - Learning - Belief - Politci]
We judge an argument's strenght not by how strongly it supports the conclusion but how plausible the conclusion is in our own minds.
...
[Memory - Social - Learning - Belief - Money - Politci]
...
## Declinism
[Memory - Social - Belief - Politcs]
We tend to romanticize the past and view the future negatively, believing that societies/institutions are by large in decline.
...
- Even thougn an app's terms of service invade Sally's privacy, she'd rather not switch to another app.
...
## Zero-Risk Bias
[Belief - Money - Politci]
We prefer to reduce small risks to zero, even if we can reduce more risk overall with another adoption.
- You should probably buy the warranty

## Framing Effect
[Social - Learning - Belief - Money - Politci]
We often draw different conclusions from the same information depending on how it is presented.
- Alice hears that her favorite candidate is "killing it" with a 45% approval rating. Sally hears that the candidate is "disappointing the country" with a 45% rating. They have widly different interpretations of the same statistic.
- Una macchina sbatte su un'altra a 60 km/h. Il poliziotto chiede:
	- A che velocità andava la macchina che si è schiantata sull'altra? Rispondono 80km/h.
	- A che velocità andava la macchina che ha tamponato l'altra? Rispondono 40km/h.

## Stereotyping
[Memory - Social - Learning - Belief - Politci]
We adopt generalized belief that members of a group will have certain characteristics, despite not having information about the individual.
...
- Gli asiatici sono tutti ugali.

## Authority Bias
[Social - Belief - Money - Politcs]
...
-
\* Non *tecnicamente* un *bias cognitivo* ma altra importante forma di *bias*.
...
[Memory - Social - Money - Politcs]
We give disproportionate weight to trivial issues, often while avoiding more complex issues.
- Rather than figuring out how to help homeless, a local city government spends a lot of time discussing putting in a bike path and bike sheds
...
- Nei preparati per dolci ti fanno mettere a te a parte uova e latte

## Ben Franklin Effect
[Social - Belief - Money - Politci]
...
- Greg loaned Francis a pen. When Fracis asked to borrow $5, Grag did it readily.
...
## Suggestibility
[Memory - Social - Learning - Belief]
We, especially children, sometimes mistake ideas suggested by a questioner for memories.
- So did you fall off the couch before of after your mom hit you?

## False Memory
[Memory - Social -  Belief]
We mistake imagination for real memories
- Greg is certain Sally said a really funny joke about pinapples, when that joke actually came out from a TV show.
