...
Visualizzare vuol dire creare nella mente una sequenza di immagini continua: un film. Questo è visualizzare; è vedere un film con l’immaginazione.  
...
Al posto di “questo” ci puoi mettere ciò che vuoi. Ad esempio: c’è chi visualizza un obiettivo finale per cui sta lavorando. Obiettivo finale significa che non è qualcosa che tu ti aspetti che accadrà stasera. Magari è la vittoria di una gara che ti vedrà coinvolto tra sei mesi. Tu puoi già visualizzarla oggi; di vincere quella gara o comunque di performare bene in quella gara. 
...
In maniera generale una condizione finale alla quale stai puntando.

Questo è uno dei macroargomenti che normalmente le persone visualizzano: un obiettivo finale; un punto di arrivo.
...
Adesso che abbiamo un'immagine più precisa del quadro nella nostra testa lasciamoci trasportare dall'immaginazione ed incominciamo ad aggiungere dei dettagli al quadro usando la fantasia. Iniziamo a dipingere il nostro quadro. Da questo momento restiamo con gli occhi chiusi perché la risposta alle domande sarà solo nella nostra testa. Dobbiamo creare noi delle immagini, dei dettagli, delle sensazioni, delle situazioni. 

Continuiamo a fare l'esercizio insieme ma io inizio a parlare in prima persona perché voglio rappresentare la voce interna. Sono io che parlo a me stesso ed allo stesso tempo sei tu che parli a te stesso.

  

Incomincio a parlare in prima persona. Sono la mia voce interna che parla al mio cervello. Per parlare al mio cervello devo fargli delle domande. Questo mi permette di effettuare una VISUALIZZAZIONE efficace. 

Comincio il viaggio guidato nella mia mente. Comincio la mia VISUALIZZAZIONE:

  

Io sono dentro il quadro. Io sono nel quadro. Il mondo dipinto nel quadro é tutto intorno a me.
